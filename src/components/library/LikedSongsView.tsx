...
export function LikedSongsView({ songs }: { songs: any[] }) {
  const { currentTrack, isPlaying, setCurrentTrack, isExtracting, setLikedSongs, likedSongs, setQueue } = usePlayerStore();
                     ...
                     <td className="py-4 px-2 md:px-4 text-[10px] md:text-xs text-gray-500 font-black tabular-nums text-center">
                        {isExtracting === song.youtubeId ? (
                           ...
                           <div className="flex items-end justify-center gap-[2px] h-3">
                              <div className="w-[2px] bg-red-600 animate-music-bar" style={{ animationDelay: '0s' }} />
                              <div className="w-[2px] bg-red-600 animate-music-bar" style={{ animationDelay: '0.1s' }} />
                              <div className="w-[2px] bg-red-600 animate-music-bar" style={{ animationDelay: '0.2s' }} />
                           </div>
                        ) : (
                           index + 1
                        )}
